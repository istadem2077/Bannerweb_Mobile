...
import 'package:bannerweb_mobile/mock/mock_final_exam_page.dart';
...
void main() {
  ...
  testWidgets('FinalExamSchedulePageMock renders correctly', (WidgetTester tester) async {
    await tester.pumpWidget(
      MultiProvider(
        ...
        child: const MaterialApp(home: FinalExamSchedulePageMock()),
      ),
    );
